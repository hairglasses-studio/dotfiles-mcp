...
| Desktop Control | Hyprland, semantic AT-SPI targeting with refs/actions/multi-match queries plus window focus and value read-write helpers, session-local accessibility and D-Bus control, screenshot/OCR, clipboard, notifications, shaders, audio, and Wayland input workflows |
